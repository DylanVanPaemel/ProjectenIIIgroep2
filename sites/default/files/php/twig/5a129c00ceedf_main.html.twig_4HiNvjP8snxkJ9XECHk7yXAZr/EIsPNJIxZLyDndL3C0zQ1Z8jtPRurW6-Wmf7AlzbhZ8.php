...
/* themes/gavias_organiz/templates/page/main.html.twig */
class __TwigTemplate_62498dac4cd5ef4c52bfd1ed0f360c9ae11ae94cbebf173c6f2ddebd8bfe2ad4 extends Twig_Template
{
...
";
    ...
    {
        return "themes/gavias_organiz/templates/page/main.html.twig";
    }
...
\t\t\t \t{% set cl_main = 'col-xs-12 col-md-9 sb-r ' %}
\t\t\t{% endif %} \t\t
\t\t\t{% if page.sidebar_left %}
\t\t\t\t{% set cl_main = 'col-xs-12 col-md-9 col-md-push-3 sb-l ' %}
\t\t\t{% endif %}\t\t\t\t
      {% endif %} 
...
\t\t<!-- Sidebar Left -->
\t\t{% if page.sidebar_left %}
\t\t\t{% set cl_left = 'col-md-3 col-md-pull-9 col-sm-12 col-xs-12' %}
\t\t\t{%\tif page.sidebar_right %}
