...
/* themes/gavias_organiz/templates/block/block--system-menu-block.html.twig */
class __TwigTemplate_415fa52e37c6b1beecbd9ea32f0d23100fad96ab32e57d78a21e0deae97649ef extends Twig_Template
{
...
(isset($context["derivative_plugin_id"]) ? $context["derivative_plugin_id"] : null))));
  ...
  <h2 ";
        // line 50
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute((isset($context["title_attributes"]) ? $context["title_attributes"] : null), "setAttribute", array(0 => "id", 1 => (isset($context["heading_id"]) ? $context["heading_id"] : null)), "method"), "addClass", array(0 => "block-title"), "method"), "html", null, true));
        echo "><span>";
...
";
    ...
    {
        return "themes/gavias_organiz/templates/block/block--system-menu-block.html.twig";
    }
