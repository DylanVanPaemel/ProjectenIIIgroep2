...
function gavias_organiz_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_organiz');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_organiz_preprocess_node(&$variables) {
...
function gavias_organiz_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_organiz_preprocess_node__gallery(&$variables){
  $variables['#attached']['library'][] = 'gavias_organiz/gavias_organiz.gallery';
}


function gavias_organiz_preprocess_breadcrumb(&$variables){
...
function gavias_organiz_preprocess_uc_cart_block_title(&$variables) {
