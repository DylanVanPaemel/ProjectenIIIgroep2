...
/* themes/gavias_organiz/templates/ubercart/uc-cart-block.html.twig */
class __TwigTemplate_6f9b88366cb715c84d5a597e78ed472e60f991c21dcb1a9f23e8eb8ea5a419cf extends Twig_Template
{
  ...
  ";
      ...
      ";
                ...
                if ($this->getAttribute($context["item"], "desc", array())) {
                    ...
                    echo "<br />
        <div class=\"cart-block-item-desc\">";
                    // line 28
...
";
    ...
    {
        return "themes/gavias_organiz/templates/ubercart/uc-cart-block.html.twig";
    }
  ...
  {% for item in items %}
    <tr>
      ...
      {% if item.desc %}
        ...
        <div class=\"cart-block-item-desc\">{{ item.desc }}</div></td>
      {% else %}
